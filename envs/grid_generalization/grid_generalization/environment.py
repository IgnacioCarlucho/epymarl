...
class GridGeneralization(gym.Env):
    ...
    def _make_obs(self):
        ...
        for i in range(len(self.agents)):
            ...
            individual_obs.extend([self.agents[i].x, self.agents[i].y])
            individual_obs.extend([self.agents[i].goal_x, self.agents[i].goal_y])
            ...
            for j in range(len(self.agents)):
                ...
                individual_obs.extend([self.agents[j].x, self.agents[j].y])
