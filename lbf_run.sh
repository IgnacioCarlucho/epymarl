...
python3 src/main.py --config=maddpg --env-config=gymmb with env_args.time_limit=50 env_args.key="lbforaging:Foraging-6x6-2p-4f-coop-v2" seed=1234

# python3 src/main.py --config=maddpg --env-config=gymmb with env_args.time_limit=50 env_args.key="lbforaging:Foraging-6x6-2p-4f-coop-v2" seed=55  

# python3 src/main.py --config=maddpg --env-config=gymmb with env_args.time_limit=50 env_args.key="lbforaging:Foraging-6x6-2p-4f-coop-v2" seed=753

# python3 src/main.py --config=maa2c --env-config=gymmb with env_args.time_limit=50 env_args.key="lbforaging:Foraging-6x6-2p-4f-coop-v2" seed=1234
