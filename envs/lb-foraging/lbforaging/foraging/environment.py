...
from gym import Env
import gym
# to avoid issues between versions of gym 
...
class ForagingEnv(Env):
    ...
    def seed(self, seed=None):
        # using seeding from gym causes issues when changing versions
    ...
    def step(self, actions):
        ...
        # do you even gym bro? 
        # return nobs, [sum(nreward)]*2, all(ndone), False, ninfo
        return nobs, [sum(nreward)]*2, [all(ndone)]*2, ninfo
